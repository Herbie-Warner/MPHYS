...
from PVFunctions.CFunctions import C0,C11,C23,C24
...
def F1(s,t):
    ...
    return (interior1+interior2)*sum_12345(MGAMMA, -s/2,ME,MMU)*prefactor
...
def VertexCorrectionTotal(s,t):
    ...
    return F2(s,t)+F4(s,t)+F5(s,t)+F6(s,t)+F7(s,t) +F1(s,t)+F3(s,t)-VertexBrem(s, t)
